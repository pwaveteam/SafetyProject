...
<Button variant="action" onClick={downloadDocx} style={{ minWidth: 120 }} className="flex items-center gap-1"><Download size={18} />점검지 양식</Button>
...
{modalOpen && (<SiteManagementRegister isOpen={modalOpen} onClose={() => setModalOpen(false)} onSave={handleSave} />)}
</section>
)
}