// src/pages/SupplyChainManagement/ContractDocument.tsx
...
{
id: 3,
completionDate: "2025-06-10 13:00 ~ 15:00",
...
<Button variant="circle" style={{ minWidth: 140 }}>
조직 등록하기
</Button>
</div>
) : (
<div className="flex justify-center mb-6">
{/* 실제 조직도 이미지나 컴포넌트가 들어갈 자리 */}
</div>
)}

{modalOpen && (
<ContractDocumentRegister
isOpen={modalOpen}
