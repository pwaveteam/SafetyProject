// src/pages/SupplyChainManagement/PartnerEvaluationRegister.tsx
...
{ label: "평가지 업로드", name: "evaluationFile", type: "fileUpload", placeholder: "파일명 입력" },
]
