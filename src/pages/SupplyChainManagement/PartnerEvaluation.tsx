...
<Button variant="action" onClick={downloadDocx} style={{ minWidth: 120 }} className="flex items-center gap-1"><Download size={18} />평가지 양식</Button>
...
{modalOpen && (<PartnerEvaluationRegister isOpen={modalOpen} onClose={() => setModalOpen(false)} onSave={handleSave} />)}
</section>
)
}