...
<Button variant="action" onClick={handleOpenModal} className="flex items-center gap-1"><CirclePlus size={16} />신규등록</Button>
...
{modalOpen && (<PartnerTrainingRegister isOpen={modalOpen} onClose={handleCloseModal} onSave={handleSave} />)}
</section>
)
}