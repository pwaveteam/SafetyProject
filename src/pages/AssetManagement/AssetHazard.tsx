...
const style = `
@media (max-width: 1024px) { .responsive-font { font-size: 0.95rem !important; } }
@media (max-width: 640px) { .responsive-font { font-size: 0.87rem !important; } }
`
