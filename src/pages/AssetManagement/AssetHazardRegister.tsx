...
chemicalName: "", casNo: "", exposureLimitValue: "", exposureLimitUnit: "", dailyUsageValue: "", dailyUsageUnit: "", storageAmountValue: "", storageAmountUnit: "", corrosive: "예", toxicity: "", adverseReaction: "", registrationDate: "", msds: null as File|null, note: "", notify: false, notifyWhen: "1개월 전"
})
...
{ value: "ppb", label: "ppb" }, { value: "ppm", label: "ppm" }, { value: "mg/m³", label: "mg/m³" }, { value: "µg/m³", label: "µg/m³" }, { value: "mg/L", label: "mg/L" }, { value: "µg/L", label: "µg/L" }
]

const usageUnits = [
{ value: "µL", label: "µL" }, { value: "mL", label: "mL" }, { value: "L", label: "L" }, { value: "cm³", label: "cm³" }, { value: "m³", label: "m³" }, { value: "µg", label: "µg" }, { value: "mg", label: "mg" }, { value: "g", label: "g" }, { value: "kg", label: "kg" }
]

const storageUnits = [
{ value: "ng", label: "ng" }, { value: "µg", label: "µg" }, { value: "mg", label: "mg" }, { value: "g", label: "g" }, { value: "kg", label: "kg" }, { value: "t", label: "t" }, { value: "µL", label: "µL" }, { value: "mL", label: "mL" }, { value: "L", label: "L" }, { value: "cm³", label: "cm³" }, { value: "m³", label: "m³" }
]

const alertTimingOptions = [
{ value: "1개월 전", label: "1개월 전" }, { value: "1주일 전", label: "1주일 전" }, { value: "1일 전", label: "1일 전" }
]
...
{
label: "부식성 유무", name: "corrosive", type: "custom",
customRender: (
<RadioGroup name="corrosive" value={formData.corrosive} options={[{ value: "예", label: "예" }, { value: "아니오", label: "아니오" }]} onChange={handleChange} />
)
},
...
{
label: "알림 전송여부", name: "notify", type: "custom",
customRender: (
