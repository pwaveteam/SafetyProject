...
return(
<section className="w-full h-28 rounded-[16px] relative text-white p-6 flex items-center border border-[#cccccc]" aria-label="Banner" style={{background:"linear-gradient(135deg, #333333 20%, #5A5F63 80%)"}}>
