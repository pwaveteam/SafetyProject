...
<section className="bg-white rounded-[16px] border border-[#EFEFF3] p-6 w-full max-w-full overflow-visible" aria-label="달력">
<DashboardCalendar/>
</section>
<section className="bg-white rounded-[16px] border border-[#EFEFF3] p-6 h-full flex flex-col justify-between overflow-hidden" aria-label="대시보드 통계">
<DashboardKPI/>
</section>
</section>
