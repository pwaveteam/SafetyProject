...
{ name: "businessType1", label: "업종", type: "select", options: [
{ value: "금속가공제품 제조업", label: "금속가공제품 제조업" },
{ value: "전자제품 제조업", label: "전자제품 제조업" }
]},
{ name: "businessType2", label: "업태", type: "select", options: [
...
company: "주식회사 테스트", ceo: "박대표", address: "서울특별시 강남구 도곡동 11-1", phonePrefix: "010", phoneMiddle: "1234", phoneLast: "5678",
businessType1: "금속가공제품 제조업", businessType2: "금속제품 도매업", businessNumber: "123-45-67890", signature: "/images/sample-signature.png"
})
