...
content:
"스마트 점검 앱을 활용해 일일 현장 점검 시 위험요인을 즉시 등록하고, 24시간 이내에 시정 조치를 완료하도록 하여 재발을 방지하며\n점검 이력과 개선 현황을 월간 리포트로 경영진에 보고합니다",
managerSignature: "",
})
...
<section>
<PageTitle>방침 · 목표</PageTitle>
<div className="flex justify-between items-center mb-3">
<div>
<YearPicker
year={values.year}
onChange={year => setValues(prev => ({ ...prev, year }))}
/>
</div>
