...
const [formData, setFormData] = useState({ eduName: "", startDate: "", endDate: "", startHour: "", startMinute: "", endHour: "", endMinute: "", type: "집체교육", target: "전근로자", proof: "", notify: true, notifyWhen: "1주일 전" })
...
const fields: Field[] = [
{ label: "교육유형", name: "type", type: "select", options: [ { value: "정기 교육", label: "정기 교육" }, { value: "채용 시 교육", label: "채용 시 교육" } ] },
{ label: "교육기간", name: "educationPeriod", type: "daterange" },
{ label: "교육시간", name: "educationTime", type: "timeRange" },
{ label: "교육대상", name: "target", type: "select", options: [ { value: "전근로자", label: "전근로자" }, { value: "신입사원", label: "신입사원" }, { value: "관리자", label: "관리자" } ] },
{ label: "교육방식", name: "type", type: "select", options: [ { value: "집체교육", label: "집체교육" }, { value: "온라인교육", label: "온라인교육" } ] },
...
<h2 className="text-2xl font-semibold tracking-wide mb-3">정기교육 등록</h2>
