...
{ id: 1, eduName: "특별 안전보건교육", date: "2025-07-01", type: "특별교육", target: "신규 입사자", place: "교육실 A", trainer: "김민수" },
{ id: 2, eduName: "특별 화학물질 안전교육", date: "2025-07-15", type: "특별교육", target: "생산팀 직원", place: "회의실 3층", trainer: "이소영" },
{ id: 3, eduName: "특별 기계 안전교육", date: "2025-08-05", type: "특별교육", target: "기계팀 전원", place: "교육센터 1층", trainer: "박준형" },
]
...
if (checked.length === 0) { alert("QR 생성할 항목을 선택하세요"); return }
...
{isModalOpen && (<SpecialEducationRegister isOpen={isModalOpen} onClose={() => setIsModalOpen(false)} onSave={handleSave} />)}
</section>
)
}