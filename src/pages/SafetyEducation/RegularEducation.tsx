...
const columns: Column[] = [
  ...
  { key: "trainer", label: "강사", minWidth: 96 },
  {
    ...
    minWidth: 80,
    renderCell: () => (
      <span className="flex justify-center items-center cursor-pointer" role="button" tabIndex={0} aria-label="교육자료 다운로드">
...
const initialData: DataRow[] = [
  {
    ...
    proof: (
      <span className="flex justify-center items-center cursor-pointer" role="button" tabIndex={0} aria-label="첨부파일 다운로드">
        <Download size={19} strokeWidth={2.1} />
      </span>
    ),
  },
]
    ...
    <section className="education-content w-full bg-white">
      ...
      <div className="flex justify-between items-center mb-3">
        ...
        <div className="flex justify-end gap-2">
          ...
          <Button variant="delete" onClick={handleDelete} className="flex items-center gap-1">
            <Trash2 size={16} />
            삭제
          </Button>
        </div>
