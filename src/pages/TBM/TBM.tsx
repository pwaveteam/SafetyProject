...
function ActionButtons({ totalCount, selectedIds, onRegister, onGenerateQR, onPrint, onDelete }: ActionButtonsProps) {
return (
...
const [supervisor, setSupervisor] = React.useState("-전체-")
...
<FilterBar startDate={startDate} endDate={endDate} onStartDate={setStartDate} onEndDate={setEndDate} supervisor={supervisor} onSupervisor={setSupervisor} onSearch={() => {}} />
<ActionButtons totalCount={data.length} selectedIds={selectedIds} onRegister={handleRegister} onGenerateQR={handleGenerateQR} onPrint={handlePrint} onDelete={handleDelete} />
