// src/components/Sidebar/BusinessSidebar.tsx
...
<div className="mb-4 text-left text-[13px] select-none font-semibold text-[#99A1AD]">
사업장관리
</div>
