...
<th className="px-3 py-0 align-middle text-[0.8125rem] md:text-base text-center" style={{ minWidth: 60, maxWidth: 100, width: 60, borderRight: "1px solid #CCCCCC", background: "#EFEFF3", ...headerFontStyle }}>
<Checkbox checked={checked.length === data.length && data.length > 0} onChange={handleCheckAll} />
</th>
{columns.map((col, idx) => (
<th
key={col.key}
className="px-3 py-0 align-middle text-[0.8125rem] md:text-base text-center"
style={{
minWidth: typeof col.minWidth === "number" ? Math.max(col.minWidth, 60) : col.minWidth || 60,
maxWidth: 300,
borderRight: idx === columns.length - 1 ? "none" : "1px solid #CCCCCC",
background: "#EFEFF3",
...headerFontStyle
}}
...
<td className="px-3 py-0 align-middle text-[0.8125rem] md:text-base text-center" style={{ minWidth: 60, maxWidth: 100, width: 60, borderRight: "1px solid #CCCCCC", borderBottom: "1px solid #CCCCCC", ...bodyFontStyle }}>
...
borderRight: colIdx === columns.length - 1 ? "none" : "1px solid #CCCCCC",
