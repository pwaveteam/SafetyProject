...
export type Column = { key: string; label: string; minWidth?: string | number; renderCell?: (row: DataRow, col: Column, rowIdx: number) => React.ReactNode }
export type DataRow = { id: number | string; [key: string]: React.ReactNode }

interface DataTableProps {
columns: Column[]; data: DataRow[]; selectable?: boolean; renderCell?: (row: DataRow, col: Column, rowIdx: number) => React.ReactNode; onCheckedChange?: (checkedIds: (number | string)[]) => void
}
...
const DataTable: React.FC<DataTableProps> = ({ columns, data, renderCell, onCheckedChange }) => {
