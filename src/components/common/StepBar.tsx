...
return (
<div
className="flex items-center justify-center bg-white p-4 mb-6"
style={{
...
isActive ? "bg-[#FF3300] text-white" : "bg-gray-200 text-gray-400"
}`}
>
...
style={{ borderTopWidth: "1px", borderColor: "#DDDDDD" }}
/>
</div>
)}
</React.Fragment>
