...
if (col.key === "scheduleFirstHalf") return <Checkbox checked={item.scheduleFirstHalf} onChange={() => onChangeField(item.id, "scheduleFirstHalf", !item.scheduleFirstHalf)} />
if (col.key === "scheduleSecondHalf") return <Checkbox checked={item.scheduleSecondHalf} onChange={() => onChangeField(item.id, "scheduleSecondHalf", !item.scheduleSecondHalf)} />
